    ...
    >
      <div className="city-content">
        ...
        <section className="city-info">
          <h2>About Dharan</h2>
          <p>Dharan, the capital city of Nepal, is rich in cultural heritage and history. Nestled in the Dharan Valley at an elevation of 1,400 meters, it serves as the gateway to the Himalayas.</p>
