    ...
    >
      <div className="city-content">
        ...
        <section className="city-info">
          <h2>About Biratnagar</h2>
          <p>Biratnagar, the capital city of Nepal, is rich in cultural heritage and history. Nestled in the Biratnagar Valley at an elevation of 1,400 meters, it serves as the gateway to the Himalayas.</p>
          ...
          <div className="info-grid">
            ...
            <div className="info-card">
              ...
              <ul>
                ...
                <li>Biratnagar Durbar Square</li>
