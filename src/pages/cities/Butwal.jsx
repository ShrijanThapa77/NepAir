    ...
    >
      <div className="city-content">
        ...
        <section className="city-info">
          <h2>About Butwal</h2>
          <p>Butwal, the capital city of Nepal, is rich in cultural heritage and history. Nestled in the Butwal Valley at an elevation of 1,400 meters, it serves as the gateway to the Himalayas.</p>
