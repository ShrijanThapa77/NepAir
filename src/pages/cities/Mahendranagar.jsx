  ...
  if (loading) {
    return (
      <div className="loading-container">
        ...
        <p>Loading Mahendranagar AQI Data...</p>
      </div>
    );
  }
  ...
  return (
    <div className="dashboard-container" style={{ backgroundImage: `url(${BG})` }}>
      ...
      <header className="dashboard-header">
        <h1>Mahendranagar Air Quality Dashboard</h1>
...
Dominant: ${hour.dominantPollutant}`}
      ...
      <footer className="dashboard-footer">
        ...
        <p>© {new Date().getFullYear()} Mahendranagar Air Quality Monitoring | All rights reserved</p>
