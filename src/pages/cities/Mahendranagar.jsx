    ...
    >
      <div className="city-content">
        ...
        <section className="city-info">
          <h2>About Mahendranagar</h2>
          <p>Mahendranagar, the capital city of Nepal, is rich in cultural heritage and history. Nestled in the Mahendranagar Valley at an elevation of 1,400 meters, it serves as the gateway to the Himalayas.</p>
          ...
          <div className="info-grid">
            ...
            <div className="info-card">
              ...
              <ul>
                ...
                <li>Mahendranagar Durbar Square</li>
